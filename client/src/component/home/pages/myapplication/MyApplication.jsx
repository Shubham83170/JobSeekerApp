    ...
    <div className='pt-5' style={{ minHeight: "100vh", backgroundColor: "#f0f2f5", fontFamily: "'Segoe UI', sans-serif" }}>
      <div className="container pt-5">
        ...
        <div className="row g-4">
          {application.length > 0 ? application.map((d, i) => (
          ...
          )) : <div className='text-center '><p className=' text-danger fs-5'>You haven’t applied for any jobs yet. Apply now to continue*.</p></div>}
        </div>
      </div>
    </div>
